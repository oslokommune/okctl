...
grafana:
  ...
  env:
    ...
    GF_SERVER_DOMAIN: {{.GrafanaHostname}}
    ...
    GF_AUTH_GENERIC_OAUTH_AUTH_URL: https://{{.AuthHostname}}/oauth2/authorize
    GF_AUTH_GENERIC_OAUTH_API_URL: https://{{.AuthHostname}}/oauth2/userInfo
    GF_AUTH_GENERIC_OAUTH_TOKEN_URL: https://{{.AuthHostname}}/oauth2/token
  ...
  envValueFrom:
    GF_SECURITY_SECRET_KEY:
      secretKeyRef:
        ...
        key: {{.SecretsGrafanaCookieSecretKey}}
    GF_AUTH_GENERIC_OAUTH_CLIENT_SECRET:
      secretKeyRef:
        name: {{.SecretsConfigName}}
        key: {{.SecretsGrafanaOauthClientSecretKey}}

  admin:
    existingSecret: {{.SecretsConfigName}}
    userKey: {{.SecretsGrafanaAdminUserKey}}
    passwordKey: {{.SecretsGrafanaAdminPassKey}}
