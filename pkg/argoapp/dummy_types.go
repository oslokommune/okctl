...
/*
 * Copied directly from https://github.com/argoproj/argo-cd/blob/6b106768a5133dbbb9dae76282013bdbc7216f09/pkg/apis/application/v1alpha1/types.go
...
/* OKCTL EDIT: removed omitempty from SyncPolicyAutomated Prune and SelfHeal */
type SyncPolicyAutomated struct {
	...
	SelfHeal bool `json:"selfHeal" protobuf:"bytes,2,opt,name=selfHeal"`
}
